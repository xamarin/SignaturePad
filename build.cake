    ...
    .Does(() =>
{
    ...
    EnsureDirectoryExists("./output/net472/");
    ...
    CopyFiles($"./src/SignaturePad.WPF/bin/{configuration}/SignaturePad.*", "./output/net472/");
    CopyFiles($"./src/SignaturePad.GTK/bin/{configuration}/SignaturePad.*", "./output/net471/");
    ...
    CopyFiles($"./src/SignaturePad.Forms.WPF/bin/{configuration}/SignaturePad.Forms.*", "./output/net472/");
    CopyFiles($"./src/SignaturePad.Forms.GTK/bin/{configuration}/SignaturePad.Forms.*", "./output/net471/");
