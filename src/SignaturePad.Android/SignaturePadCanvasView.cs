...
namespace Xamarin.Controls
{
	public partial class SignaturePadCanvasView : FrameLayout
	{
		...
		private Bitmap GetImageInternal (float scale, System.Drawing.RectangleF croppedRectangle, System.Drawing.SizeF imageSize, float strokeWidth, Color strokeColor, Color backgroundColor)
		{
			...
			using (var canvas = new Canvas (image))
			{
				...
				// cropping / scaling
				canvas.Translate (-croppedRectangle.Left, -croppedRectangle.Top);
		...
		private async Task<Stream> GetImageStreamInternal (SignatureImageFormat format, float scale, System.Drawing.RectangleF croppedRectangle, System.Drawing.SizeF imageSize, float strokeWidth, Color strokeColor, Color backgroundColor)
		{
